...
A terraform module to create a Klaytn service chain network including SCN, SPN, SEN nodes and bridge to existing main chain EN nodes. It help you to build infrustcture on AWS. After create instance nodes with this module, you may can install and configure Klaytn node with [klaytn-ansible](https://github.com/klaytn/klaytn-ansible) project under Klaytn organization. For more details regarding Klaytn service chains, please refer to [Klaytn Docs](https://docs.klaytn.com/node/service-chain).
...
| en\_security\_group\_id | Security group ID of existing EN instance nodes | `string` | `n/a` | yes |
